...
const navItemsConfig: NavItemConfig[] = [
  {
    icon: <FaBriefcase size={24} strokeWidth={1.25} />,
    labelKey: "portfolio",
    href: "/",
  },
  {
    icon: <FaCode size={24} strokeWidth={1.25} />,
    labelKey: "projects",
    href: "/projects",
  },
  {
    icon: <FaUser size={24} strokeWidth={1.25} />,
    labelKey: "about",
    href: "/about",
  },
];
  ...
  return (
    <header ref={navRef} className="mx-auto mt-8 z-50 w-[100%-2rem] max-w-md">
      <nav className="block relative">
        <div className="relative z-20 flex items-center justify-center bg-mintcream/80 rounded-3xl px-2 h-16">
