  ...
  return (
    <section className="mx-auto mt-16 w-full max-w-xl sm:max-w-3xl">
      ...
      <div>
        <button
          key="all"
          className="py-0.5 px-3 mx-1 cursor-pointer font-semibold rounded-full bg-mintcream/80 hover:bg-mintcream-80 hover:translate-x-0.5 hover:-traslate-y-1 transition-all duration-300"
        >
          {t("filterBtn")}
        </button>
      ...
      <div className="flex flex-row items-center gap-4 mb-8 w-full max-w-3xl px-4 sm:px-0"></div>
